...
type DownloadArtifactRequest struct {
	...
	Type          ArtifactType           `protobuf:"varint,2,opt,name=type,proto3,enum=storageservice.ArtifactType" json:"type,omitempty"`                  // Type of the artifact to download
	Environment   EnvironmentName        `protobuf:"varint,3,opt,name=environment,proto3,enum=storageservice.EnvironmentName" json:"environment,omitempty"` // Environment of the artifact to download
...
const file_node_service_v1_node_service_proto_rawDesc = "" +
	"\n" +
	"\"node_service/v1/node_service.proto\x12\x0estorageservice\x1a\x1fgoogle/protobuf/timestamp.proto\"\x9e\x01\n" +
	"\x17DownloadArtifactRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x120\n" +
	"\x04type\x18\x02 \x01(\x0e2\x1c.storageservice.ArtifactTypeR\x04type\x12A\n" +
	"\venvironment\x18\x03 \x01(\x0e2\x1f.storageservice.EnvironmentNameR\venvironment\"`\n" +
	...
	"\x12PRODUCTION_TESTNET\x10\x022t\n" +
	"\vNodeService\x12e\n" +
	"\x10DownloadArtifact\x12'.storageservice.DownloadArtifactRequest\x1a(.storageservice.DownloadArtifactResponseBQZOgithub.com/smartcontractkit/chainlink-protos/storage-service/go;storage_serviceb\x06proto3"
...
var file_node_service_v1_node_service_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_node_service_v1_node_service_proto_goTypes = []any{
	(ArtifactType)(0),                // 0: storageservice.ArtifactType
	(EnvironmentName)(0),             // 1: storageservice.EnvironmentName
	(*DownloadArtifactRequest)(nil),  // 2: storageservice.DownloadArtifactRequest
	(*DownloadArtifactResponse)(nil), // 3: storageservice.DownloadArtifactResponse
	(*timestamppb.Timestamp)(nil),    // 4: google.protobuf.Timestamp
}
var file_node_service_v1_node_service_proto_depIdxs = []int32{
	0, // 0: storageservice.DownloadArtifactRequest.type:type_name -> storageservice.ArtifactType
	1, // 1: storageservice.DownloadArtifactRequest.environment:type_name -> storageservice.EnvironmentName
	4, // 2: storageservice.DownloadArtifactResponse.expiry:type_name -> google.protobuf.Timestamp
	2, // 3: storageservice.NodeService.DownloadArtifact:input_type -> storageservice.DownloadArtifactRequest
	3, // 4: storageservice.NodeService.DownloadArtifact:output_type -> storageservice.DownloadArtifactResponse
