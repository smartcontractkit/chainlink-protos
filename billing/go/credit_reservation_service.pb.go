...
const file_creditreservation_v1alpha_credit_reservation_service_proto_rawDesc = "" +
	...
	"\aentries\x18\x04 \x03(\v2(.creditreservation.v1alpha.RateCardEntryR\aentries\"\x84\x03\n" +
	...
	"\x10credits_consumed\x18\a \x01(\tR\x0fcreditsConsumed\"\xf3\x02\n" +
	"\rRateCardEntry\x12L\n" +
	...
	"\x0echain_selector\x18\x03 \x01(\x04R\rchainSelector\"\x9b\x02\n" +
	"\x13GetRateCardResponse\x12B\n" +
	"\aentries\x18\x01 \x03(\v2(.creditreservation.v1alpha.RateCardEntryR\aentries\x12y\n" +
	"\x15gas_tokens_per_credit\x18\x02 \x03(\v2F.creditreservation.v1alpha.GetRateCardResponse.GasTokensPerCreditEntryR\x12gasTokensPerCredit\x1aE\n" +
	...
	"\x15MEASUREMENT_UNIT_COST\x10\x052\x97\x04\n" +
	...
	"\x15SubmitWorkflowReceipt\x127.creditreservation.v1alpha.SubmitWorkflowReceiptRequest\x1a\x16.google.protobuf.Empty\x12l\n" +
	"\vGetRateCard\x12-.creditreservation.v1alpha.GetRateCardRequest\x1a..creditreservation.v1alpha.GetRateCardResponseBAZ?github.com/smartcontractkit/chainlink-protos/billing/go;billingb\x06proto3"
