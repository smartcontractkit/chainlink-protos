...
const (
	...
	// Bytes (CONSENSUS).
	MeasurementUnit_MEASUREMENT_UNIT_BYTES MeasurementUnit = 1
	// Milliseconds (COMPUTE).
	MeasurementUnit_MEASUREMENT_UNIT_MILLISECONDS MeasurementUnit = 2
	// Operations count (ALERTS, EVENTS, CHAIN_CALLS, TRIGGERS).
	MeasurementUnit_MEASUREMENT_UNIT_OPERATIONS MeasurementUnit = 3
	// Cost (GAS).
	MeasurementUnit_MEASUREMENT_UNIT_COST MeasurementUnit = 4
)
...
var (
	MeasurementUnit_name = map[int32]string{
		...
		1: "MEASUREMENT_UNIT_BYTES",
		2: "MEASUREMENT_UNIT_MILLISECONDS",
		3: "MEASUREMENT_UNIT_OPERATIONS",
		4: "MEASUREMENT_UNIT_COST",
	}
...
type SubmitWorkflowReceiptRequest struct {
	...
	MeteringMode            bool                   `protobuf:"varint,7,opt,name=meteringMode,proto3" json:"meteringMode,omitempty"`
	MeteringModeErr         string                 `protobuf:"bytes,8,opt,name=meteringModeErr,proto3" json:"meteringModeErr,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *SubmitWorkflowReceiptRequest) GetMeteringMode() bool {
	if x != nil {
...
func (x *SubmitWorkflowReceiptRequest) GetMeteringModeErr() string {
	if x != nil {
		return x.MeteringModeErr
	}
	return ""
}
...
const file_creditreservation_v1_credit_reservation_service_proto_rawDesc = "" +
	...
	"\aentries\x18\x04 \x03(\v2#.creditreservation.v1.RateCardEntryR\aentries\"\x96\x03\n" +
	...
	"\fmeteringMode\x18\a \x01(\bR\fmeteringMode\x12(\n" +
	"\x0fmeteringModeErr\x18\b \x01(\tR\x0fmeteringModeErr\"\xe9\x02\n" +
	"\rRateCardEntry\x12G\n" +
	...
	"\x16MEASUREMENT_UNIT_BYTES\x10\x01\x12!\n" +
	"\x1dMEASUREMENT_UNIT_MILLISECONDS\x10\x02\x12\x1f\n" +
	"\x1bMEASUREMENT_UNIT_OPERATIONS\x10\x03\x12\x19\n" +
	"\x15MEASUREMENT_UNIT_COST\x10\x042\xf4\x03\n" +
