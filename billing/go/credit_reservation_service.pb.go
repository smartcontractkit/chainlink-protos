...
const file_creditreservation_v1_credit_reservation_service_proto_rawDesc = "" +
	...
	"\bmetering\x18\x06 \x01(\v2\x1c.workflows.v1.MeteringReportR\bmetering\"\xdd\x02\n" +
	"\rRateCardEntry\x12;\n" +
	"\tunit_type\x18\x01 \x01(\x0e2\x1e.creditreservation.v1.UnitTypeR\bunitType\x12P\n" +
	"\x10measurement_unit\x18\x02 \x01(\x0e2%.creditreservation.v1.MeasurementUnitR\x0fmeasurementUnit\x12(\n" +
	"\x10units_per_credit\x18\x03 \x01(\x01R\x0eunitsPerCredit\x12\x1d\n" +
	"\n" +
	...
	"\aentries\x18\x01 \x03(\v2#.creditreservation.v1.RateCardEntryR\aentries*\x95\x02\n" +
	"\bUnitType\x12\x19\n" +
	"\x15UNIT_TYPE_UNSPECIFIED\x10\x00\x12\x17\n" +
	"\x13UNIT_TYPE_WF_MEMORY\x10\x01\x12\x17\n" +
	"\x13UNIT_TYPE_CONSENSUS\x10\x02\x12\x15\n" +
	"\x11UNIT_TYPE_COMPUTE\x10\x03\x12\x19\n" +
	"\x15UNIT_TYPE_DON_STORAGE\x10\x04\x12\x18\n" +
	"\x14UNIT_TYPE_WF_STORAGE\x10\x05\x12\x14\n" +
	"\x10UNIT_TYPE_ALERTS\x10\x06\x12\x11\n" +
	"\rUNIT_TYPE_GAS\x10\a\x12\x14\n" +
	"\x10UNIT_TYPE_EVENTS\x10\b\x12\x19\n" +
	"\x15UNIT_TYPE_CHAIN_CALLS\x10\t\x12\x16\n" +
	"\x12UNIT_TYPE_TRIGGERS\x10\n" +
	"*\xe2\x01\n" +
