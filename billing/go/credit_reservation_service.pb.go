...
type GetWorkflowExecutionRatesResponse struct {
	...
	GasDecimalPoints map[uint64]uint32 `protobuf:"bytes,4,rep,name=gas_decimal_points,json=gasDecimalPoints,proto3" json:"gas_decimal_points,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *GetWorkflowExecutionRatesResponse) GetGasDecimalPoints() map[uint64]uint32 {
	if x != nil {
		return x.GasDecimalPoints
	}
	return nil
}
...
const file_creditreservation_v1alpha_credit_reservation_service_proto_rawDesc = "" +
	...
	"\x15workflow_execution_id\x18\x04 \x01(\tR\x13workflowExecutionId\"\xa9\x04\n" +
	...
	"\x15gas_tokens_per_credit\x18\x03 \x03(\v2T.creditreservation.v1alpha.GetWorkflowExecutionRatesResponse.GasTokensPerCreditEntryR\x12gasTokensPerCredit\x12\x80\x01\n" +
	"\x12gas_decimal_points\x18\x04 \x03(\v2R.creditreservation.v1alpha.GetWorkflowExecutionRatesResponse.GasDecimalPointsEntryR\x10gasDecimalPoints\x1aE\n" +
	"\x17GasTokensPerCreditEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x04R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1aC\n" +
	"\x15GasDecimalPointsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x04R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\rR\x05value:\x028\x01\"\xf8\x01\n" +
...
var file_creditreservation_v1alpha_credit_reservation_service_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_creditreservation_v1alpha_credit_reservation_service_proto_goTypes = []any{
	...
	nil,                                              // 17: creditreservation.v1alpha.GetWorkflowExecutionRatesResponse.GasDecimalPointsEntry
	(*timestamppb.Timestamp)(nil),                    // 18: google.protobuf.Timestamp
	(*events.MeteringReport)(nil),                    // 19: workflows.v1.MeteringReport
	(*emptypb.Empty)(nil),                            // 20: google.protobuf.Empty
}
var file_creditreservation_v1alpha_credit_reservation_service_proto_depIdxs = []int32{
	18, // 0: creditreservation.v1alpha.OrganizationCredits.created_at:type_name -> google.protobuf.Timestamp
	18, // 1: creditreservation.v1alpha.OrganizationCredits.updated_at:type_name -> google.protobuf.Timestamp
	...
	19, // 4: creditreservation.v1alpha.SubmitWorkflowReceiptRequest.metering:type_name -> workflows.v1.MeteringReport
	...
	18, // 7: creditreservation.v1alpha.RateCard.created_at:type_name -> google.protobuf.Timestamp
	18, // 8: creditreservation.v1alpha.RateCard.updated_at:type_name -> google.protobuf.Timestamp
	...
	17, // 11: creditreservation.v1alpha.GetWorkflowExecutionRatesResponse.gas_decimal_points:type_name -> creditreservation.v1alpha.GetWorkflowExecutionRatesResponse.GasDecimalPointsEntry
	2,  // 12: creditreservation.v1alpha.CheckAggregationStatusRequest.CallType:type_name -> creditreservation.v1alpha.CallType
	3,  // 13: creditreservation.v1alpha.CheckAggregationStatusResponse.AggregationStatus:type_name -> creditreservation.v1alpha.AggregationStatus
	4,  // 14: creditreservation.v1alpha.CheckAggregationStatusResponse.Outcome:type_name -> creditreservation.v1alpha.AggregationOutcome
	6,  // 15: creditreservation.v1alpha.CreditReservationService.GetOrganizationCreditsByWorkflow:input_type -> creditreservation.v1alpha.GetOrganizationCreditsByWorkflowRequest
	8,  // 16: creditreservation.v1alpha.CreditReservationService.ReserveCredits:input_type -> creditreservation.v1alpha.ReserveCreditsRequest
	10, // 17: creditreservation.v1alpha.CreditReservationService.SubmitWorkflowReceipt:input_type -> creditreservation.v1alpha.SubmitWorkflowReceiptRequest
	12, // 18: creditreservation.v1alpha.CreditReservationService.GetWorkflowExecutionRates:input_type -> creditreservation.v1alpha.GetWorkflowExecutionRatesRequest
	14, // 19: creditreservation.v1alpha.CreditReservationService.CheckAggregationStatus:input_type -> creditreservation.v1alpha.CheckAggregationStatusRequest
	7,  // 20: creditreservation.v1alpha.CreditReservationService.GetOrganizationCreditsByWorkflow:output_type -> creditreservation.v1alpha.GetOrganizationCreditsByWorkflowResponse
	9,  // 21: creditreservation.v1alpha.CreditReservationService.ReserveCredits:output_type -> creditreservation.v1alpha.ReserveCreditsResponse
	20, // 22: creditreservation.v1alpha.CreditReservationService.SubmitWorkflowReceipt:output_type -> google.protobuf.Empty
	13, // 23: creditreservation.v1alpha.CreditReservationService.GetWorkflowExecutionRates:output_type -> creditreservation.v1alpha.GetWorkflowExecutionRatesResponse
	15, // 24: creditreservation.v1alpha.CreditReservationService.CheckAggregationStatus:output_type -> creditreservation.v1alpha.CheckAggregationStatusResponse
