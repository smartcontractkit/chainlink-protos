...
func (c *appServiceClient) Version(ctx context.Context, in *VersionRequest, opts ...grpc.CallOption) (*VersionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tooling.distributor.app.AppService/Version", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *appServiceClient) Health(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tooling.distributor.app.AppService/Health", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AppService_Version_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tooling.distributor.app.AppService/Version",
	}
...
func _AppService_Health_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tooling.distributor.app.AppService/Health",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
