...
const file_job_distributor_v1_node_node_proto_rawDesc = "" +
	"\n" +
	"\"job-distributor/v1/node/node.proto\x12\vapi.node.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a,job-distributor/v1/shared/ptypes/label.proto\"\xe4\x02\n" +
	"\x04Node\x12\x0e\n" +
	...
	"\fworkflow_key\x18\t \x01(\tH\x00R\vworkflowKey\x88\x01\x01B\x0f\n" +
	"\r_workflow_key\"C\n" +
	"\x05Chain\x12\x0e\n" +
	...
	"\rchain_configs\x18\x01 \x03(\v2\x18.api.node.v1.ChainConfigR\fchainConfigs*\x96\x01\n" +
	"\tChainType\x12\x1a\n" +
