...
type TransferJobRequest struct {
	...
	TargetManagerPubKey string                 `protobuf:"bytes,2,opt,name=target_manager_pub_key,json=targetManagerPubKey,proto3" json:"target_manager_pub_key,omitempty"` // Public key of the target JD manager.
...
func (x *TransferJobRequest) GetTargetManagerPubKey() string {
	if x != nil {
		return x.TargetManagerPubKey
	}
	return ""
}
...
const file_job_distributor_v1_job_job_proto_rawDesc = "" +
	...
	"\t_acked_atB\x17\n" +
	"\x15_response_received_at\"\x93\x01\n" +
	"\x12TransferJobRequest\x12&\n" +
	"\x0fremote_job_uuid\x18\x01 \x01(\tR\rremoteJobUuid\x123\n" +
	"\x16target_manager_pub_key\x18\x02 \x01(\tR\x13targetManagerPubKey\x12 \n" +
...
var file_job_distributor_v1_job_job_proto_depIdxs = []int32{
	...
	2,  // 10: api.job.v1.TransferJobResponse.job:type_name -> api.job.v1.Job
	2,  // 11: api.job.v1.GetJobResponse.job:type_name -> api.job.v1.Job
	3,  // 12: api.job.v1.GetProposalResponse.proposal:type_name -> api.job.v1.Proposal
	25, // 13: api.job.v1.ListJobsRequest.filter:type_name -> api.job.v1.ListJobsRequest.Filter
	2,  // 14: api.job.v1.ListJobsResponse.jobs:type_name -> api.job.v1.Job
	26, // 15: api.job.v1.ListProposalsRequest.filter:type_name -> api.job.v1.ListProposalsRequest.Filter
	3,  // 16: api.job.v1.ListProposalsResponse.proposals:type_name -> api.job.v1.Proposal
	30, // 17: api.job.v1.ProposeJobRequest.labels:type_name -> api.label.Label
	3,  // 18: api.job.v1.ProposeJobResponse.proposal:type_name -> api.job.v1.Proposal
	30, // 19: api.job.v1.BatchProposeJobRequest.labels:type_name -> api.label.Label
	27, // 20: api.job.v1.BatchProposeJobResponse.success_responses:type_name -> api.job.v1.BatchProposeJobResponse.SuccessResponsesEntry
	28, // 21: api.job.v1.BatchProposeJobResponse.failed_responses:type_name -> api.job.v1.BatchProposeJobResponse.FailedResponsesEntry
	3,  // 22: api.job.v1.RevokeJobResponse.proposal:type_name -> api.job.v1.Proposal
	2,  // 23: api.job.v1.DeleteJobResponse.job:type_name -> api.job.v1.Job
	30, // 24: api.job.v1.UpdateJobRequest.labels:type_name -> api.label.Label
	2,  // 25: api.job.v1.UpdateJobResponse.job:type_name -> api.job.v1.Job
	31, // 26: api.job.v1.ListJobsRequest.Filter.selectors:type_name -> api.label.Selector
	15, // 27: api.job.v1.BatchProposeJobResponse.SuccessResponsesEntry.value:type_name -> api.job.v1.ProposeJobResponse
	17, // 28: api.job.v1.BatchProposeJobResponse.FailedResponsesEntry.value:type_name -> api.job.v1.ProposeJobFailure
	6,  // 29: api.job.v1.JobService.GetJob:input_type -> api.job.v1.GetJobRequest
	8,  // 30: api.job.v1.JobService.GetProposal:input_type -> api.job.v1.GetProposalRequest
	10, // 31: api.job.v1.JobService.ListJobs:input_type -> api.job.v1.ListJobsRequest
	12, // 32: api.job.v1.JobService.ListProposals:input_type -> api.job.v1.ListProposalsRequest
	14, // 33: api.job.v1.JobService.ProposeJob:input_type -> api.job.v1.ProposeJobRequest
	16, // 34: api.job.v1.JobService.BatchProposeJob:input_type -> api.job.v1.BatchProposeJobRequest
	19, // 35: api.job.v1.JobService.RevokeJob:input_type -> api.job.v1.RevokeJobRequest
	21, // 36: api.job.v1.JobService.DeleteJob:input_type -> api.job.v1.DeleteJobRequest
	23, // 37: api.job.v1.JobService.UpdateJob:input_type -> api.job.v1.UpdateJobRequest
	4,  // 38: api.job.v1.JobService.TransferJob:input_type -> api.job.v1.TransferJobRequest
	7,  // 39: api.job.v1.JobService.GetJob:output_type -> api.job.v1.GetJobResponse
	9,  // 40: api.job.v1.JobService.GetProposal:output_type -> api.job.v1.GetProposalResponse
	11, // 41: api.job.v1.JobService.ListJobs:output_type -> api.job.v1.ListJobsResponse
	13, // 42: api.job.v1.JobService.ListProposals:output_type -> api.job.v1.ListProposalsResponse
	15, // 43: api.job.v1.JobService.ProposeJob:output_type -> api.job.v1.ProposeJobResponse
	18, // 44: api.job.v1.JobService.BatchProposeJob:output_type -> api.job.v1.BatchProposeJobResponse
	20, // 45: api.job.v1.JobService.RevokeJob:output_type -> api.job.v1.RevokeJobResponse
	22, // 46: api.job.v1.JobService.DeleteJob:output_type -> api.job.v1.DeleteJobResponse
	24, // 47: api.job.v1.JobService.UpdateJob:output_type -> api.job.v1.UpdateJobResponse
	5,  // 48: api.job.v1.JobService.TransferJob:output_type -> api.job.v1.TransferJobResponse
