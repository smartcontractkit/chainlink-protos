...
const (
	...
	JobService_TransferJob_FullMethodName     = "/api.job.v1.JobService/TransferJob"
)
...
type JobServiceClient interface {
	...
	TransferJob(ctx context.Context, in *TransferJobRequest, opts ...grpc.CallOption) (*TransferJobResponse, error)
}
...
func (c *jobServiceClient) GetProposal(ctx context.Context, in *GetProposalRequest, opts ...grpc.CallOption) (*GetProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, JobService_GetProposal_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobServiceClient) ListProposals(ctx context.Context, in *ListProposalsRequest, opts ...grpc.CallOption) (*ListProposalsResponse, error) {
	...
	err := c.cc.Invoke(ctx, JobService_ListProposals_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobServiceClient) ProposeJob(ctx context.Context, in *ProposeJobRequest, opts ...grpc.CallOption) (*ProposeJobResponse, error) {
	...
	err := c.cc.Invoke(ctx, JobService_ProposeJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobServiceClient) RevokeJob(ctx context.Context, in *RevokeJobRequest, opts ...grpc.CallOption) (*RevokeJobResponse, error) {
	...
	err := c.cc.Invoke(ctx, JobService_RevokeJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobServiceClient) TransferJob(ctx context.Context, in *TransferJobRequest, opts ...grpc.CallOption) (*TransferJobResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TransferJobResponse)
	err := c.cc.Invoke(ctx, JobService_TransferJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedJobServiceServer) TransferJob(context.Context, *TransferJobRequest) (*TransferJobResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TransferJob not implemented")
}
...
func _JobService_TransferJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TransferJobRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(JobServiceServer).TransferJob(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: JobService_TransferJob_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JobServiceServer).TransferJob(ctx, req.(*TransferJobRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var JobService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _JobService_TransferJob_Handler,
		},
	},
