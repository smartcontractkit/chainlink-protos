...
// 	protoc        v5.29.3
// source: v1/workflows/metadata.proto
...
func (x *WorkflowMetadata) Reset() {
	*x = WorkflowMetadata{}
	mi := &file_v1_workflows_metadata_proto_msgTypes[0]
...
func (*WorkflowMetadata) Descriptor() ([]byte, []int) {
	return file_v1_workflows_metadata_proto_rawDescGZIP(), []int{0}
}
...
var File_v1_workflows_metadata_proto protoreflect.FileDescriptor

const file_v1_workflows_metadata_proto_rawDesc = "" +
	"\n" +
	"\x1bv1/workflows/metadata.proto\x12\fworkflows.v1\"\xec\x03\n" +
	...
	"\rengineVersion\x18\r \x01(\tR\rengineVersionBFZDgithub.com/smartcontractkit/chainlink-protos/cre/go/workflows/eventsb\x06proto3"

var (
	file_v1_workflows_metadata_proto_rawDescOnce sync.Once
	file_v1_workflows_metadata_proto_rawDescData []byte
)

func file_v1_workflows_metadata_proto_rawDescGZIP() []byte {
	file_v1_workflows_metadata_proto_rawDescOnce.Do(func() {
		file_v1_workflows_metadata_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_v1_workflows_metadata_proto_rawDesc), len(file_v1_workflows_metadata_proto_rawDesc)))
	})
	return file_v1_workflows_metadata_proto_rawDescData
}

var file_v1_workflows_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_v1_workflows_metadata_proto_goTypes = []any{
	(*WorkflowMetadata)(nil), // 0: workflows.v1.WorkflowMetadata
}
var file_v1_workflows_metadata_proto_depIdxs = []int32{
...
func init() { file_v1_workflows_metadata_proto_init() }
func file_v1_workflows_metadata_proto_init() {
	if File_v1_workflows_metadata_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_v1_workflows_metadata_proto_rawDesc), len(file_v1_workflows_metadata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_v1_workflows_metadata_proto_goTypes,
		DependencyIndexes: file_v1_workflows_metadata_proto_depIdxs,
		MessageInfos:      file_v1_workflows_metadata_proto_msgTypes,
	}.Build()
	File_v1_workflows_metadata_proto = out.File
	file_v1_workflows_metadata_proto_goTypes = nil
	file_v1_workflows_metadata_proto_depIdxs = nil
}
