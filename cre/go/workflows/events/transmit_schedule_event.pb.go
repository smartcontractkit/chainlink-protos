...
// 	protoc        v5.29.3
// source: v1/workflows/transmit_schedule_event.proto
...
func (x *TransmissionsScheduledEvent) Reset() {
	*x = TransmissionsScheduledEvent{}
	mi := &file_v1_workflows_transmit_schedule_event_proto_msgTypes[0]
...
func (*TransmissionsScheduledEvent) Descriptor() ([]byte, []int) {
	return file_v1_workflows_transmit_schedule_event_proto_rawDescGZIP(), []int{0}
}
...
var File_v1_workflows_transmit_schedule_event_proto protoreflect.FileDescriptor

const file_v1_workflows_transmit_schedule_event_proto_rawDesc = "" +
	"\n" +
	"*v1/workflows/transmit_schedule_event.proto\x12\fworkflows.v1\"\xc1\x03\n" +
	...
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01BFZDgithub.com/smartcontractkit/chainlink-protos/cre/go/workflows/eventsb\x06proto3"

var (
	file_v1_workflows_transmit_schedule_event_proto_rawDescOnce sync.Once
	file_v1_workflows_transmit_schedule_event_proto_rawDescData []byte
)

func file_v1_workflows_transmit_schedule_event_proto_rawDescGZIP() []byte {
	file_v1_workflows_transmit_schedule_event_proto_rawDescOnce.Do(func() {
		file_v1_workflows_transmit_schedule_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_v1_workflows_transmit_schedule_event_proto_rawDesc), len(file_v1_workflows_transmit_schedule_event_proto_rawDesc)))
	})
	return file_v1_workflows_transmit_schedule_event_proto_rawDescData
}

var file_v1_workflows_transmit_schedule_event_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_v1_workflows_transmit_schedule_event_proto_goTypes = []any{
...
var file_v1_workflows_transmit_schedule_event_proto_depIdxs = []int32{
...
func init() { file_v1_workflows_transmit_schedule_event_proto_init() }
func file_v1_workflows_transmit_schedule_event_proto_init() {
	if File_v1_workflows_transmit_schedule_event_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_v1_workflows_transmit_schedule_event_proto_rawDesc), len(file_v1_workflows_transmit_schedule_event_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_v1_workflows_transmit_schedule_event_proto_goTypes,
		DependencyIndexes: file_v1_workflows_transmit_schedule_event_proto_depIdxs,
		MessageInfos:      file_v1_workflows_transmit_schedule_event_proto_msgTypes,
	}.Build()
	File_v1_workflows_transmit_schedule_event_proto = out.File
	file_v1_workflows_transmit_schedule_event_proto_goTypes = nil
	file_v1_workflows_transmit_schedule_event_proto_depIdxs = nil
}
