...
type TriggerSubscription struct {
	...
	Payload       *anypb.Any             `protobuf:"bytes,2,opt,name=payload,proto3" json:"payload,omitempty"`
	Method        string                 `protobuf:"bytes,3,opt,name=method,proto3" json:"method,omitempty"`
	PreHook       bool                   `protobuf:"varint,4,opt,name=pre_hook,json=preHook,proto3" json:"pre_hook,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_sdk_v1alpha_sdk_proto_rawDesc = "" +
	...
	"\bpre_hook\x18\x04 \x01(\bR\apreHook\"d\n" +
...
var file_sdk_v1alpha_sdk_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_sdk_v1alpha_sdk_proto_goTypes = []any{
	(AggregationType)(0),               // 0: sdk.v1alpha.AggregationType
	(Mode)(0),                          // 1: sdk.v1alpha.Mode
	(CapabilityRestrictionType)(0),     // 2: sdk.v1alpha.CapabilityRestrictionType
	...
	(*TriggerSubscriptionRequest)(nil), // 12: sdk.v1alpha.TriggerSubscriptionRequest
	(*Trigger)(nil),                    // 13: sdk.v1alpha.Trigger
	(*AwaitCapabilitiesRequest)(nil),   // 14: sdk.v1alpha.AwaitCapabilitiesRequest
	(*AwaitCapabilitiesResponse)(nil),  // 15: sdk.v1alpha.AwaitCapabilitiesResponse
	(*ExecuteRequest)(nil),             // 16: sdk.v1alpha.ExecuteRequest
	(*ExecutionResult)(nil),            // 17: sdk.v1alpha.ExecutionResult
	(*GetSecretsRequest)(nil),          // 18: sdk.v1alpha.GetSecretsRequest
	(*AwaitSecretsRequest)(nil),        // 19: sdk.v1alpha.AwaitSecretsRequest
	(*AwaitSecretsResponse)(nil),       // 20: sdk.v1alpha.AwaitSecretsResponse
	(*SecretRequest)(nil),              // 21: sdk.v1alpha.SecretRequest
	(*Secret)(nil),                     // 22: sdk.v1alpha.Secret
	(*SecretError)(nil),                // 23: sdk.v1alpha.SecretError
	(*SecretResponse)(nil),             // 24: sdk.v1alpha.SecretResponse
	(*SecretResponses)(nil),            // 25: sdk.v1alpha.SecretResponses
	(*MethodRestriction)(nil),          // 26: sdk.v1alpha.MethodRestriction
	(*CapabilityRestriction)(nil),      // 27: sdk.v1alpha.CapabilityRestriction
	(*CapabilityRestrictions)(nil),     // 28: sdk.v1alpha.CapabilityRestrictions
	(*SecretPrefixRestriction)(nil),    // 29: sdk.v1alpha.SecretPrefixRestriction
	(*SecretRestriction)(nil),          // 30: sdk.v1alpha.SecretRestriction
	(*SecretsRestritions)(nil),         // 31: sdk.v1alpha.SecretsRestritions
	(*Restrictions)(nil),               // 32: sdk.v1alpha.Restrictions
	nil,                                // 33: sdk.v1alpha.FieldsMap.FieldsEntry
	nil,                                // 34: sdk.v1alpha.AwaitCapabilitiesResponse.ResponsesEntry
	nil,                                // 35: sdk.v1alpha.AwaitSecretsResponse.ResponsesEntry
	(*pb.Value)(nil),                   // 36: values.v1.Value
	(*anypb.Any)(nil),                  // 37: google.protobuf.Any
	(*emptypb.Empty)(nil),              // 38: google.protobuf.Empty
}
var file_sdk_v1alpha_sdk_proto_depIdxs = []int32{
	36, // 0: sdk.v1alpha.SimpleConsensusInputs.value:type_name -> values.v1.Value
	5,  // 1: sdk.v1alpha.SimpleConsensusInputs.descriptors:type_name -> sdk.v1alpha.ConsensusDescriptor
	36, // 2: sdk.v1alpha.SimpleConsensusInputs.default:type_name -> values.v1.Value
	33, // 3: sdk.v1alpha.FieldsMap.fields:type_name -> sdk.v1alpha.FieldsMap.FieldsEntry
	...
	37, // 7: sdk.v1alpha.CapabilityRequest.payload:type_name -> google.protobuf.Any
	37, // 8: sdk.v1alpha.CapabilityResponse.payload:type_name -> google.protobuf.Any
	37, // 9: sdk.v1alpha.TriggerSubscription.payload:type_name -> google.protobuf.Any
	11, // 10: sdk.v1alpha.TriggerSubscriptionRequest.subscriptions:type_name -> sdk.v1alpha.TriggerSubscription
	37, // 11: sdk.v1alpha.Trigger.payload:type_name -> google.protobuf.Any
	34, // 12: sdk.v1alpha.AwaitCapabilitiesResponse.responses:type_name -> sdk.v1alpha.AwaitCapabilitiesResponse.ResponsesEntry
	38, // 13: sdk.v1alpha.ExecuteRequest.subscribe:type_name -> google.protobuf.Empty
	13, // 14: sdk.v1alpha.ExecuteRequest.trigger:type_name -> sdk.v1alpha.Trigger
	13, // 15: sdk.v1alpha.ExecuteRequest.pre_hook:type_name -> sdk.v1alpha.Trigger
	36, // 16: sdk.v1alpha.ExecutionResult.value:type_name -> values.v1.Value
	12, // 17: sdk.v1alpha.ExecutionResult.trigger_subscriptions:type_name -> sdk.v1alpha.TriggerSubscriptionRequest
	32, // 18: sdk.v1alpha.ExecutionResult.restrictions:type_name -> sdk.v1alpha.Restrictions
	21, // 19: sdk.v1alpha.GetSecretsRequest.requests:type_name -> sdk.v1alpha.SecretRequest
	35, // 20: sdk.v1alpha.AwaitSecretsResponse.responses:type_name -> sdk.v1alpha.AwaitSecretsResponse.ResponsesEntry
	22, // 21: sdk.v1alpha.SecretResponse.secret:type_name -> sdk.v1alpha.Secret
	23, // 22: sdk.v1alpha.SecretResponse.error:type_name -> sdk.v1alpha.SecretError
	24, // 23: sdk.v1alpha.SecretResponses.responses:type_name -> sdk.v1alpha.SecretResponse
	26, // 24: sdk.v1alpha.CapabilityRestriction.method:type_name -> sdk.v1alpha.MethodRestriction
	27, // 25: sdk.v1alpha.CapabilityRestrictions.restrictions:type_name -> sdk.v1alpha.CapabilityRestriction
	2,  // 26: sdk.v1alpha.CapabilityRestrictions.type:type_name -> sdk.v1alpha.CapabilityRestrictionType
	22, // 27: sdk.v1alpha.SecretRestriction.exact_secret:type_name -> sdk.v1alpha.Secret
	29, // 28: sdk.v1alpha.SecretRestriction.prefixed_secret:type_name -> sdk.v1alpha.SecretPrefixRestriction
	30, // 29: sdk.v1alpha.SecretsRestritions.restrictions:type_name -> sdk.v1alpha.SecretRestriction
	31, // 30: sdk.v1alpha.Restrictions.secrets:type_name -> sdk.v1alpha.SecretsRestritions
	28, // 31: sdk.v1alpha.Restrictions.capabilities:type_name -> sdk.v1alpha.CapabilityRestrictions
	5,  // 32: sdk.v1alpha.FieldsMap.FieldsEntry.value:type_name -> sdk.v1alpha.ConsensusDescriptor
	10, // 33: sdk.v1alpha.AwaitCapabilitiesResponse.ResponsesEntry.value:type_name -> sdk.v1alpha.CapabilityResponse
	25, // 34: sdk.v1alpha.AwaitSecretsResponse.ResponsesEntry.value:type_name -> sdk.v1alpha.SecretResponses
...
func file_sdk_v1alpha_sdk_proto_init() {
	...
	file_sdk_v1alpha_sdk_proto_msgTypes[24].OneofWrappers = []any{
		(*CapabilityRestriction_Method)(nil),
	}
	file_sdk_v1alpha_sdk_proto_msgTypes[27].OneofWrappers = []any{
