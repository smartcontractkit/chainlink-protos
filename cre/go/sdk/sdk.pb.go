...
type TeeTypeSelection struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Types         []TeeType              `protobuf:"varint,1,rep,packed,name=types,proto3,enum=sdk.v1alpha.TeeType" json:"types,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TeeTypeSelection) GetTypes() []TeeType {
	if x != nil {
		return x.Types
	}
	return nil
...
var file_sdk_v1alpha_sdk_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_sdk_v1alpha_sdk_proto_goTypes = []any{
	...
	(*TeeTypeSelection)(nil),           // 12: sdk.v1alpha.TeeTypeSelection
	(*Tee)(nil),                        // 13: sdk.v1alpha.Tee
	...
	(*AwaitCapabilitiesRequest)(nil),   // 17: sdk.v1alpha.AwaitCapabilitiesRequest
	(*AwaitCapabilitiesResponse)(nil),  // 18: sdk.v1alpha.AwaitCapabilitiesResponse
	(*ExecuteRequest)(nil),             // 19: sdk.v1alpha.ExecuteRequest
	(*ExecutionResult)(nil),            // 20: sdk.v1alpha.ExecutionResult
	(*GetSecretsRequest)(nil),          // 21: sdk.v1alpha.GetSecretsRequest
	(*AwaitSecretsRequest)(nil),        // 22: sdk.v1alpha.AwaitSecretsRequest
	(*AwaitSecretsResponse)(nil),       // 23: sdk.v1alpha.AwaitSecretsResponse
	(*SecretRequest)(nil),              // 24: sdk.v1alpha.SecretRequest
	(*Secret)(nil),                     // 25: sdk.v1alpha.Secret
	(*SecretError)(nil),                // 26: sdk.v1alpha.SecretError
	(*SecretResponse)(nil),             // 27: sdk.v1alpha.SecretResponse
	(*SecretResponses)(nil),            // 28: sdk.v1alpha.SecretResponses
	nil,                                // 29: sdk.v1alpha.FieldsMap.FieldsEntry
	nil,                                // 30: sdk.v1alpha.AwaitCapabilitiesResponse.ResponsesEntry
	nil,                                // 31: sdk.v1alpha.AwaitSecretsResponse.ResponsesEntry
	(*pb.Value)(nil),                   // 32: values.v1.Value
	(*anypb.Any)(nil),                  // 33: google.protobuf.Any
	(*emptypb.Empty)(nil),              // 34: google.protobuf.Empty
}
var file_sdk_v1alpha_sdk_proto_depIdxs = []int32{
	32, // 0: sdk.v1alpha.SimpleConsensusInputs.value:type_name -> values.v1.Value
	5,  // 1: sdk.v1alpha.SimpleConsensusInputs.descriptors:type_name -> sdk.v1alpha.ConsensusDescriptor
	32, // 2: sdk.v1alpha.SimpleConsensusInputs.default:type_name -> values.v1.Value
	29, // 3: sdk.v1alpha.FieldsMap.fields:type_name -> sdk.v1alpha.FieldsMap.FieldsEntry
	...
	33, // 7: sdk.v1alpha.CapabilityRequest.payload:type_name -> google.protobuf.Any
	33, // 8: sdk.v1alpha.CapabilityResponse.payload:type_name -> google.protobuf.Any
	33, // 9: sdk.v1alpha.TriggerSubscription.payload:type_name -> google.protobuf.Any
	2,  // 10: sdk.v1alpha.TeeTypeSelection.types:type_name -> sdk.v1alpha.TeeType
	34, // 11: sdk.v1alpha.Tee.any:type_name -> google.protobuf.Empty
	12, // 12: sdk.v1alpha.Tee.type_selection:type_name -> sdk.v1alpha.TeeTypeSelection
	11, // 13: sdk.v1alpha.TriggerSubscriptionRequest.subscriptions:type_name -> sdk.v1alpha.TriggerSubscription
	33, // 14: sdk.v1alpha.Trigger.payload:type_name -> google.protobuf.Any
	13, // 15: sdk.v1alpha.Requirements.tee:type_name -> sdk.v1alpha.Tee
	30, // 16: sdk.v1alpha.AwaitCapabilitiesResponse.responses:type_name -> sdk.v1alpha.AwaitCapabilitiesResponse.ResponsesEntry
	34, // 17: sdk.v1alpha.ExecuteRequest.subscribe:type_name -> google.protobuf.Empty
	15, // 18: sdk.v1alpha.ExecuteRequest.trigger:type_name -> sdk.v1alpha.Trigger
	32, // 19: sdk.v1alpha.ExecutionResult.value:type_name -> values.v1.Value
	14, // 20: sdk.v1alpha.ExecutionResult.trigger_subscriptions:type_name -> sdk.v1alpha.TriggerSubscriptionRequest
	24, // 21: sdk.v1alpha.GetSecretsRequest.requests:type_name -> sdk.v1alpha.SecretRequest
	31, // 22: sdk.v1alpha.AwaitSecretsResponse.responses:type_name -> sdk.v1alpha.AwaitSecretsResponse.ResponsesEntry
	25, // 23: sdk.v1alpha.SecretResponse.secret:type_name -> sdk.v1alpha.Secret
	26, // 24: sdk.v1alpha.SecretResponse.error:type_name -> sdk.v1alpha.SecretError
	27, // 25: sdk.v1alpha.SecretResponses.responses:type_name -> sdk.v1alpha.SecretResponse
	5,  // 26: sdk.v1alpha.FieldsMap.FieldsEntry.value:type_name -> sdk.v1alpha.ConsensusDescriptor
	10, // 27: sdk.v1alpha.AwaitCapabilitiesResponse.ResponsesEntry.value:type_name -> sdk.v1alpha.CapabilityResponse
	28, // 28: sdk.v1alpha.AwaitSecretsResponse.ResponsesEntry.value:type_name -> sdk.v1alpha.SecretResponses
...
func file_sdk_v1alpha_sdk_proto_init() {
	...
	file_sdk_v1alpha_sdk_proto_msgTypes[16].OneofWrappers = []any{
