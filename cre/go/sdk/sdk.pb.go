...
func (x *CapabilityResponse) GetCapabilityId() string {
	if x != nil {
...
type ExecutionResult struct {
	...
	FailedCapabilityId *string `protobuf:"bytes,4,opt,name=failed_capability_id,json=failedCapabilityId,proto3,oneof" json:"failed_capability_id,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *ExecutionResult) GetFailedCapabilityId() string {
	if x != nil && x.FailedCapabilityId != nil {
		return *x.FailedCapabilityId
	}
	return ""
}
