...
const blockchainAptosV1alphaClientEmbedded = `syntax = "proto3";
...
const aptosAptosEmbedded = `syntax = "proto3";
...
service Aptos {
  rpc AccountAPTBalance(AccountAPTBalanceRequest) returns (AccountAPTBalanceReply);
  rpc View(ViewRequest) returns (ViewReply);
  rpc EventsByHandle(EventsByHandleRequest) returns (EventsByHandleReply);
  rpc TransactionByHash(TransactionByHashRequest) returns (TransactionByHashReply);
...
const solanaSolanaEmbedded = `syntax = "proto3";
...
var allFiles = []*embeddedFile{
	...
	{
		name:    "chains/aptos/aptos.proto",
		content: aptosAptosEmbedded,
	},
	{
		name:    "chains/solana/solana.proto",
		content: solanaSolanaEmbedded,
	},
}
