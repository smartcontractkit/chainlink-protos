...
const file_workflows_bridge_status_v1_bridge_status_proto_rawDesc = "" +
	...
	"\ttimestamp\x18\v \x01(\tR\ttimestamp\"L\n" +
	"\aJobInfo\x12&\n" +
	"\x0fexternal_job_id\x18\x01 \x01(\tR\rexternalJobId\x12\x19\n" +
	"\bjob_name\x18\x02 \x01(\tR\ajobName\"\x8c\x01\n" +
	"\vRuntimeInfo\x12!\n" +
...
var file_workflows_bridge_status_v1_bridge_status_proto_depIdxs = []int32{
	...
	1, // 4: bridge_status.v1.BridgeStatusEvent.jobs:type_name -> bridge_status.v1.JobInfo
