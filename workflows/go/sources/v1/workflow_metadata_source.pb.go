...
const file_sources_v1_workflow_metadata_source_proto_rawDesc = "" +
	"\n" +
	")sources/v1/workflow_metadata_source.proto\x12\x14workflows.sources.v1\"\x91\x01\n" +
	...
	"\rstatus_filter\x18\x04 \x03(\rR\fstatusFilter\"\xaf\x01\n" +
	"\x1cListWorkflowMetadataResponse\x12D\n" +
	"\tworkflows\x18\x01 \x03(\v2&.workflows.sources.v1.WorkflowMetadataR\tworkflows\x12.\n" +
	"\x04head\x18\x02 \x01(\v2\x1a.workflows.sources.v1.HeadR\x04head\x12\x19\n" +
	...
	"\ttimestamp\x18\x03 \x01(\x04R\ttimestamp2\x9e\x01\n" +
	"\x1dWorkflowMetadataSourceService\x12}\n" +
	"\x14ListWorkflowMetadata\x121.workflows.sources.v1.ListWorkflowMetadataRequest\x1a2.workflows.sources.v1.ListWorkflowMetadataResponseBFZDgithub.com/smartcontractkit/chainlink-protos/workflows/go/sources/v1b\x06proto3"
...
var file_sources_v1_workflow_metadata_source_proto_goTypes = []any{
	(*ListWorkflowMetadataRequest)(nil),  // 0: workflows.sources.v1.ListWorkflowMetadataRequest
	(*ListWorkflowMetadataResponse)(nil), // 1: workflows.sources.v1.ListWorkflowMetadataResponse
	(*WorkflowMetadata)(nil),             // 2: workflows.sources.v1.WorkflowMetadata
	(*Head)(nil),                         // 3: workflows.sources.v1.Head
}
var file_sources_v1_workflow_metadata_source_proto_depIdxs = []int32{
	2, // 0: workflows.sources.v1.ListWorkflowMetadataResponse.workflows:type_name -> workflows.sources.v1.WorkflowMetadata
	3, // 1: workflows.sources.v1.ListWorkflowMetadataResponse.head:type_name -> workflows.sources.v1.Head
	0, // 2: workflows.sources.v1.WorkflowMetadataSourceService.ListWorkflowMetadata:input_type -> workflows.sources.v1.ListWorkflowMetadataRequest
	1, // 3: workflows.sources.v1.WorkflowMetadataSourceService.ListWorkflowMetadata:output_type -> workflows.sources.v1.ListWorkflowMetadataResponse
