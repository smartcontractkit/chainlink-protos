...
type WorkflowExecutionFinished struct {
	...
	// JSON-encoded values.Value (protojson) of the workflow output.
	// Absent on failed executions.
...
func (x *WorkflowExecutionFinished) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
const file_workflows_v2_workflow_execution_finished_proto_rawDesc = "" +
	"\n" +
	".workflows/v2/workflow_execution_finished.proto\x12\fworkflows.v2\x1a\x1bworkflows/v2/cre_info.proto\x1a\x1fworkflows/v2/workflow_key.proto\x1a\x1eworkflows/v2/xxx_no_send.proto\"\xb3\x03\n" +
	...
	"\x10classifiedStatus\x18\b \x01(\x0e2'.workflows.v2.ClassifiedExecutionStatusR\x10classifiedStatus\x12\x16\n" +
	"\x06result\x18\t \x01(\tR\x06resultB>Z<github.com/smartcontractkit/chainlink-protos/workflows/go/v2b\x06proto3"
