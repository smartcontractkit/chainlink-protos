...
// 	protoc        v5.29.5
// source: workflows/v2/workflow_updated.proto
...
func (x *WorkflowUpdated) Reset() {
	*x = WorkflowUpdated{}
	mi := &file_workflows_v2_workflow_updated_proto_msgTypes[0]
...
func (*WorkflowUpdated) Descriptor() ([]byte, []int) {
	return file_workflows_v2_workflow_updated_proto_rawDescGZIP(), []int{0}
}
...
var (
	...
	file_workflows_v2_workflow_updated_proto_rawDescData []byte
)

func file_workflows_v2_workflow_updated_proto_rawDescGZIP() []byte {
	file_workflows_v2_workflow_updated_proto_rawDescOnce.Do(func() {
		file_workflows_v2_workflow_updated_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_workflows_v2_workflow_updated_proto_rawDesc), len(file_workflows_v2_workflow_updated_proto_rawDesc)))
	})
	return file_workflows_v2_workflow_updated_proto_rawDescData
}
...
func file_workflows_v2_workflow_updated_proto_init() {
	if File_workflows_v2_workflow_updated_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_workflows_v2_workflow_updated_proto_rawDesc), len(file_workflows_v2_workflow_updated_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_workflows_v2_workflow_updated_proto_goTypes,
		DependencyIndexes: file_workflows_v2_workflow_updated_proto_depIdxs,
		MessageInfos:      file_workflows_v2_workflow_updated_proto_msgTypes,
	}.Build()
	File_workflows_v2_workflow_updated_proto = out.File
	file_workflows_v2_workflow_updated_proto_goTypes = nil
	file_workflows_v2_workflow_updated_proto_depIdxs = nil
}
