...
// 	protoc        v6.32.0
// source: workflows/v1/transmissions_scheduled_event.proto
...
func (x *TransmissionsScheduledEvent) Reset() {
	*x = TransmissionsScheduledEvent{}
	mi := &file_workflows_v1_transmissions_scheduled_event_proto_msgTypes[0]
...
func (*TransmissionsScheduledEvent) Descriptor() ([]byte, []int) {
	return file_workflows_v1_transmissions_scheduled_event_proto_rawDescGZIP(), []int{0}
}
...
var File_workflows_v1_transmissions_scheduled_event_proto protoreflect.FileDescriptor

const file_workflows_v1_transmissions_scheduled_event_proto_rawDesc = "" +
	"\n" +
	"0workflows/v1/transmissions_scheduled_event.proto\x12\fworkflows.v1\"\xc1\x03\n" +
...
var (
	file_workflows_v1_transmissions_scheduled_event_proto_rawDescOnce sync.Once
	file_workflows_v1_transmissions_scheduled_event_proto_rawDescData []byte
)

func file_workflows_v1_transmissions_scheduled_event_proto_rawDescGZIP() []byte {
	file_workflows_v1_transmissions_scheduled_event_proto_rawDescOnce.Do(func() {
		file_workflows_v1_transmissions_scheduled_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_workflows_v1_transmissions_scheduled_event_proto_rawDesc), len(file_workflows_v1_transmissions_scheduled_event_proto_rawDesc)))
	})
	return file_workflows_v1_transmissions_scheduled_event_proto_rawDescData
}

var file_workflows_v1_transmissions_scheduled_event_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_workflows_v1_transmissions_scheduled_event_proto_goTypes = []any{
...
var file_workflows_v1_transmissions_scheduled_event_proto_depIdxs = []int32{
...
func init() { file_workflows_v1_transmissions_scheduled_event_proto_init() }
func file_workflows_v1_transmissions_scheduled_event_proto_init() {
	if File_workflows_v1_transmissions_scheduled_event_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_workflows_v1_transmissions_scheduled_event_proto_rawDesc), len(file_workflows_v1_transmissions_scheduled_event_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_workflows_v1_transmissions_scheduled_event_proto_goTypes,
		DependencyIndexes: file_workflows_v1_transmissions_scheduled_event_proto_depIdxs,
		MessageInfos:      file_workflows_v1_transmissions_scheduled_event_proto_msgTypes,
	}.Build()
	File_workflows_v1_transmissions_scheduled_event_proto = out.File
	file_workflows_v1_transmissions_scheduled_event_proto_goTypes = nil
	file_workflows_v1_transmissions_scheduled_event_proto_depIdxs = nil
}
