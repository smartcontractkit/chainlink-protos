...
//go:generate protoc --proto_path=../ --go_out=./ --go_opt=module=github.com/smartcontractkit/chainlink-protos/workflows/go ../workflows/v1/metering_detail.proto ../workflows/v1/metering_step.proto ../workflows/v1/metering.proto
