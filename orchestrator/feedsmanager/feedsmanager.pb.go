...
type TransferJobRequest struct {
	...
	SourceManagerPubKey string                 `protobuf:"bytes,2,opt,name=source_manager_pub_key,json=sourceManagerPubKey,proto3" json:"source_manager_pub_key,omitempty"` // Public key of the source feeds manager (remove later)
	TargetManagerPubKey string                 `protobuf:"bytes,3,opt,name=target_manager_pub_key,json=targetManagerPubKey,proto3" json:"target_manager_pub_key,omitempty"` // Public key of the target feeds manager
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
type Job struct {
	...
	Labels        map[string]string      `protobuf:"bytes,3,rep,name=labels,proto3" json:"labels,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // Job labels
...
type TransferedJobRequest struct {
	...
	// Target node CSA key where the job should be transferred
	TargetNodePubKey string `protobuf:"bytes,3,opt,name=target_node_pub_key,json=targetNodePubKey,proto3" json:"target_node_pub_key,omitempty"`
	// Optional: Source JD identifier for tracking
	SourceJdCsaKey *string `protobuf:"bytes,4,opt,name=source_jd_csa_key,json=sourceJdCsaKey,proto3,oneof" json:"source_jd_csa_key,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *TransferedJobRequest) GetTargetNodePubKey() string {
	if x != nil {
		return x.TargetNodePubKey
	}
	return ""
}

func (x *TransferedJobRequest) GetSourceJdCsaKey() string {
	if x != nil && x.SourceJdCsaKey != nil {
		return *x.SourceJdCsaKey
	}
	return ""
}
...
const file_orchestrator_feedsmanager_feedsmanager_proto_rawDesc = "" +
	...
	"\x14CancelledJobResponse\"\x8e\x01\n" +
	"\x12TransferJobRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x123\n" +
	"\x16source_manager_pub_key\x18\x02 \x01(\tR\x13sourceManagerPubKey\x123\n" +
	"\x16target_manager_pub_key\x18\x03 \x01(\tR\x13targetManagerPubKey\"%\n" +
	...
	"\apeer_id\x18\x01 \x01(\tR\x06peerId\x12\x1d\n" +
	"\n" +
	"public_key\x18\x02 \x01(\tR\tpublicKey\"\x99\x02\n" +
	"\x03Job\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\x12\x1f\n" +
	"\voriginal_id\x18\x02 \x01(\tR\n" +
	"originalId\x12,\n" +
	"\x06labels\x18\x03 \x03(\v2\x14.cfm.Job.LabelsEntryR\x06labels\x129\n" +
	"\n" +
	...
	"\tproposals\x18\x02 \x03(\v2\r.cfm.ProposalR\tproposals\x12-\n" +
	"\x13target_node_pub_key\x18\x03 \x01(\tR\x10targetNodePubKey\x12.\n" +
	"\x11source_jd_csa_key\x18\x04 \x01(\tH\x00R\x0esourceJdCsaKey\x88\x01\x01B\x14\n" +
	"\x12_source_jd_csa_key\"\x17\n" +
...
var file_orchestrator_feedsmanager_feedsmanager_proto_goTypes = []any{
	...
	(*Job)(nil),                     // 30: cfm.Job
	(*Proposal)(nil),                // 31: cfm.Proposal
	(*TransferedJobRequest)(nil),    // 32: cfm.TransferedJobRequest
	(*TransferedJobResponse)(nil),   // 33: cfm.TransferedJobResponse
	(*OCR1Config_P2PKeyBundle)(nil), // 34: cfm.OCR1Config.P2PKeyBundle
	(*OCR1Config_OCRKeyBundle)(nil), // 35: cfm.OCR1Config.OCRKeyBundle
	(*OCR2Config_P2PKeyBundle)(nil), // 36: cfm.OCR2Config.P2PKeyBundle
	(*OCR2Config_OCRKeyBundle)(nil), // 37: cfm.OCR2Config.OCRKeyBundle
	(*OCR2Config_Plugins)(nil),      // 38: cfm.OCR2Config.Plugins
	nil,                             // 39: cfm.UpdateNodeResponse.ChainConfigErrorsEntry
	nil,                             // 40: cfm.Job.LabelsEntry
...
var file_orchestrator_feedsmanager_feedsmanager_proto_depIdxs = []int32{
	...
	34, // 2: cfm.OCR1Config.p2p_key_bundle:type_name -> cfm.OCR1Config.P2PKeyBundle
	35, // 3: cfm.OCR1Config.ocr_key_bundle:type_name -> cfm.OCR1Config.OCRKeyBundle
	36, // 4: cfm.OCR2Config.p2p_key_bundle:type_name -> cfm.OCR2Config.P2PKeyBundle
	37, // 5: cfm.OCR2Config.ocr_key_bundle:type_name -> cfm.OCR2Config.OCRKeyBundle
	38, // 6: cfm.OCR2Config.plugins:type_name -> cfm.OCR2Config.Plugins
	...
	39, // 16: cfm.UpdateNodeResponse.chain_config_errors:type_name -> cfm.UpdateNodeResponse.ChainConfigErrorsEntry
	40, // 17: cfm.Job.labels:type_name -> cfm.Job.LabelsEntry
	41, // 18: cfm.Job.created_at:type_name -> google.protobuf.Timestamp
	41, // 19: cfm.Job.updated_at:type_name -> google.protobuf.Timestamp
	2,  // 20: cfm.Proposal.status:type_name -> cfm.ProposalStatus
	3,  // 21: cfm.Proposal.delivery_status:type_name -> cfm.ProposalDeliveryStatus
	41, // 22: cfm.Proposal.created_at:type_name -> google.protobuf.Timestamp
	41, // 23: cfm.Proposal.updated_at:type_name -> google.protobuf.Timestamp
	30, // 24: cfm.TransferedJobRequest.job:type_name -> cfm.Job
	31, // 25: cfm.TransferedJobRequest.proposals:type_name -> cfm.Proposal
	12, // 26: cfm.UpdateNodeResponse.ChainConfigErrorsEntry.value:type_name -> cfm.ChainConfigError
	13, // 27: cfm.FeedsManager.ApprovedJob:input_type -> cfm.ApprovedJobRequest
	15, // 28: cfm.FeedsManager.Healthcheck:input_type -> cfm.HealthcheckRequest
	10, // 29: cfm.FeedsManager.UpdateNode:input_type -> cfm.UpdateNodeRequest
	17, // 30: cfm.FeedsManager.RejectedJob:input_type -> cfm.RejectedJobRequest
	19, // 31: cfm.FeedsManager.CancelledJob:input_type -> cfm.CancelledJobRequest
	32, // 32: cfm.FeedsManager.TransferedJob:input_type -> cfm.TransferedJobRequest
	23, // 33: cfm.NodeService.ProposeJob:input_type -> cfm.ProposeJobRequest
	25, // 34: cfm.NodeService.DeleteJob:input_type -> cfm.DeleteJobRequest
	27, // 35: cfm.NodeService.RevokeJob:input_type -> cfm.RevokeJobRequest
	21, // 36: cfm.NodeService.TransferJob:input_type -> cfm.TransferJobRequest
	14, // 37: cfm.FeedsManager.ApprovedJob:output_type -> cfm.ApprovedJobResponse
	16, // 38: cfm.FeedsManager.Healthcheck:output_type -> cfm.HealthcheckResponse
	11, // 39: cfm.FeedsManager.UpdateNode:output_type -> cfm.UpdateNodeResponse
	18, // 40: cfm.FeedsManager.RejectedJob:output_type -> cfm.RejectedJobResponse
	20, // 41: cfm.FeedsManager.CancelledJob:output_type -> cfm.CancelledJobResponse
	33, // 42: cfm.FeedsManager.TransferedJob:output_type -> cfm.TransferedJobResponse
	24, // 43: cfm.NodeService.ProposeJob:output_type -> cfm.ProposeJobResponse
	26, // 44: cfm.NodeService.DeleteJob:output_type -> cfm.DeleteJobResponse
	28, // 45: cfm.NodeService.RevokeJob:output_type -> cfm.RevokeJobResponse
	22, // 46: cfm.NodeService.TransferJob:output_type -> cfm.TransferJobResponse
...
func file_orchestrator_feedsmanager_feedsmanager_proto_init() {
	...
	file_orchestrator_feedsmanager_feedsmanager_proto_msgTypes[28].OneofWrappers = []any{}
	type x struct{}
