...
const file_orchestrator_feedsmanager_feedsmanager_proto_rawDesc = "" +
	...
	"\x1b_account_address_public_key\"\xd8\x03\n" +
	...
	"\fworkflow_key\x18\v \x01(\tH\x00R\vworkflowKey\x88\x01\x01B\x0f\n" +
	...
	"\rJOB_TYPE_OCR2\x10\x03*\x96\x01\n" +
	"\tChainType\x12\x1a\n" +
	...
	"\x0fCHAIN_TYPE_TRON\x10\x052\xd8\x02\n" +
	"\fFeedsManager\x12@\n" +
